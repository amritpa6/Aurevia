    ...
    onClick={()=>{
      ...
      <div className='relative h-48 overflow-hidden'>
        ...
        <div className='absolute bottom-4 right-4 bg-black/80 backdrop-blur-sm text-white px-3 py-2 rounded-lg'>
            <span className='semibold'> {currencySymbol}{car.pricePerDay}</span>
      ...
      <div className= 'p-4 sm:p-5'>
        ...
        <div className='flex justify-between items-start mb-z'>
            <div>
                <h3 className='text-1g font-medium'>{car.brand} {car.model}</h3>
