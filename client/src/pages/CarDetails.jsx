...
const CarDetails = () => {
    ...
    const {cars, axios, pickupDate, returnDate, setPickupDate, setReturnDate, navigate} = UseAppContext();
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
        ...
        className ='lg:col-span-2'>
          ...
          className ='space-y-6'>
            <div>
              ...
              <p className='text-gray-500 text-1g'>{car.category} • {car.year}</p>
            </div>
            ...
            <div className='grid grid-cols-2 sm:grid-cols-4 gap-4'>
                {[
                  ...
                  key={text} className='flex flex-col items-center bg-light p-4 rounded-lg'>
                    <img src={icon.icon} alt="" className='h-5 mb-2'/>
                    {icon.text}
                  </motion.div>
                ))}
            </div>
          ...
          <div>
            ...
            <ul className='grid grid-cols-1 sm:grid-cols-2 gap-2'>  
              {
              ["360 Camera","Bluetooth","Cruise Control","Heated Seats","Keyless Entry","Leather Seats","Navigation System"].map((feature) => (
                <li key={feature} className='flex items-center text-gray-500 gap-2'>
        ...
        onSubmit={handleSubmit} className=' shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500'>
          ...
          <p className='flex items-center justify-between text-2xl text-gray-800 font-semibold'>
            $ {car.pricePerDay} <span className='text-base text-gray-400 font-normal'>per day</span>
          </p>
